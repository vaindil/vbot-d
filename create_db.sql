...
CREATE TABLE user_alias (
    id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    user_id integer REFERENCES tracked_user(id),
...
CREATE TABLE action_taken (
    id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    user_id integer NOT NULL REFERENCES tracked_user(id),
    performed_by integer NOT NULL REFERENCES tracked_user(id),
    logged_at timestamptz NOT NULL,
...
CREATE TABLE user_note (
    id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    user_id integer NOT NULL REFERENCES tracked_user(id),
    taken_by integer NOT NULL REFERENCES tracked_user(id),
    logged_at timestamptz NOT NULL,
    note text NOT NULL
);